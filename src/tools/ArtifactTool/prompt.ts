...
// ARTIFACT_PROMPT is the verbatim long prompt() text, decoded from the minified
// `.bun` section (minified symbol xB4). ARTIFACT_DESCRIPTION is the short
// description() string.
...
export const ARTIFACT_PROMPT = `Render an HTML or Markdown file to an Artifact — a default-private web page hosted on claude.ai that the user can later choose to share with their teammates. Use this when communicating visually with an image, diagram, or rich HTML/Markdown would be clearer than terminal text.
